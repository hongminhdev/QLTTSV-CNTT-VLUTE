                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <table>
                                <tr height="50px">
									<td style="color: white; font-size: 20px;">
										<!-- Account --> <span style="color: black">Tên</span>
									</td>
									<td>
										<input type="text" name="" value="<?php echo $ten ?>" style="padding: 20px;" disabled>
									</td> 
								</tr>
								<tr height="50px">
									<td style="color: white; font-size: 20px;">
										<!-- Account --> <span style="color: black">Email</span>
									</td>
									<td>
										<input type="text" name="email" value="<?php echo $email ?>" style="padding: 20px" disabled>
									</td> 
								</tr>
								<tr>
									<td style="color: white; font-size: 20px;">
										<!-- Password --> <span style="color: black">Ngày tạo</span>
									</td>
									<td>
										<input type="date" name="" value="<?php echo $ngaytao ?>" style="padding: 20px" disabled>
									</td> 
								</tr>
						</table>
                        ...
                        <div class="message"> if(isset($message)) { echo $message; } ?></div>
                            <table>
                                <tr height="50px">
                                    <input type="hidden" name="< echo $email ?>" value="< echo $email ?>" id="email">
									<td style="color: white; font-size: 20px;">
										<span style="color: black" id="sessionNum_counter">Mật khẩu hiện tại</span>
									</td>
									<td>
										<input type="password" name="opwd" id="opwd" minlength="6" maxlength="25" placeholder="Mật khẩu hiện tại" style="padding: 20px;" required>
									</td> 
								</tr>
								<tr height="50px">
									<td style="color: white; font-size: 20px;">
