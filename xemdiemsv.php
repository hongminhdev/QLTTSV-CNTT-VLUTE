            ...
            <div class="main-container">
				<!-- <div id="main-contain"> -->
                    <?php
                        ...
                        $id = $_GET['id'];
                        $cn = $_GET['id_cn'];
                        $res = mysqli_query($link, "SELECT *FROM sinhvien WHERE sinhvienID=$id");
                    ...
                    ?>
                     <div id="menu">
                        <ol style="font-size: 20px; margin-left: -2px;" class="breadcrumb"> Bảng Điểm Của Sinh Viên <?php echo $tensv ?>
                            ...
                            &nbsp; &nbsp; <span style="font-size: 11px; margin-top: 8px;"> > </span> &nbsp;  &nbsp;
                            <li style="margin-top: -3px;"> <a href="xemdiemsv.php?id=<?php echo $id ?>&id_cn=<?php echo $cn ?>"><i class="fa fa-user"></i> Bảng điểm cá nhân</a> </li>
                        </ol>
                    </div>
					...
					<!-- <h3>  </h3> -->
                        ...
                        <center><form action="export_diem.php" method="POST" >
                            <input type="hidden" value="<?php echo $id ?>" name="xuat">
                            <input type="hidden" value="<?php echo $cn ?>" name="xuat_cn">
