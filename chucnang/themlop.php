    ...
    <body>
        <header> 
            <div class="container"> 
                 <div id="logo">
					  <div id="logoImg">
						   <img src="../image/lgvlute.png" width="30px">
					  </div>
					<a href="../index.php">QUẢN LÝ SINH VIÊN KHOA CNTT TRƯỜNG VLUTE</a>
				 </div>
				 <div id="accountName">
              ...
              <div id="main-contain"> 
				...
				<div class="form">
					...
					<?php
						...
						if(isset($_POST['them'])){
							if(empty($_POST['ten']) or empty($_POST['GVCN']) or empty($_POST['phonghoc'])) 
							{
