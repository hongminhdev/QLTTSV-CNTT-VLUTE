...
<div class="header">
                <div class="header-menu">
                    <a href="index.php">
                        <div class="title">VLUTE <span>Student</span></div> 
                    </a>
                    ...
                    <ul>
                        <span style="color: white; margin-top: 4%;" > <i class="fas fa-user"></i> &nbsp; <?php echo $hoten ?> </span> &nbsp; &nbsp;
                        ...
                        <div class="user-area dropdown float-right">
                            ...
                            <div class="user-menu dropdown-menu">
                                <a class="nav-link" href="thongtin_sv.php"><i class="fa fa-user"></i> Hồ sơ cá nhân </a>

                                <a class="nav-link" href="doimk.php"><i class="fa fa-cog"></i> Đổi mật khẩu </a>

                                <a class="nav-link" href="dangxuat.php"><i class="fa fa-power-off"></i> Đăng xuất </a>
                            </div>
                        </div>
            ...
            <div class="sidebar">
                <div class="sidebar-menu">
                    ...
                    <!-- <li class="item">
                        <a href="dssv.php" class="menu-btn">
                            <i class="fas fa-user-graduate"></i><span>Lớp</span>
                        </a>
                    </li> -->
                    <li class="item">
                        <a href="bangdiem_canhan.php" class="menu-btn">
                    ...
                    <li class="item">
                        <a href="thongtin_sv.php" class="menu-btn">
                            <i class="fas fa-laptop-code"></i><span>Hồ sơ cá nhân</span>
                        </a>
                    </li>
                    <li class="item">
                        <a href="doimk.php" class="menu-btn">
